@props(['placeholder','val'])
    <form class="flex justify-center" action="" method="GET">
        <input type="search" id="default-search" class="block w-full p-2 pl-15 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 " name='s' placeholder="{{ $placeholder }}" value="{{$val}}"   >
